...
const editorialSections = [
  {
    id: '01',
    title: 'O compromisso do RBN com o jornalismo',
    paragraphs: [
      'O RBN nasceu com o propósito de informar. Em um ambiente digital em que qualquer pessoa pode produzir e compartilhar conteúdo em poucos segundos, acreditamos que o jornalismo profissional tem uma responsabilidade ainda maior: apurar, verificar, contextualizar e apresentar os fatos com clareza.',
      'Nossa relação com o leitor é baseada em confiança. Por isso, estes princípios estabelecem os critérios que orientam a produção, edição e publicação do conteúdo jornalístico do RBN.',
  ...
  },
  {
    ...
    paragraphs: [
      'Para o RBN, jornalismo é a atividade de apurar e apresentar informações relevantes sobre fatos, acontecimentos e pessoas, contribuindo para que o público compreenda a realidade ao seu redor.',
  ...
  },
  {
    ...
    paragraphs: [
      ...
      'Agilidade responsável: O jornalismo digital exige velocidade, mas velocidade não deve significar precipitação. O RBN buscará publicar informações relevantes com rapidez, sem abandonar os procedimentos necessários de verificação. Ser rápido é importante. Estar correto é indispensável.'
    ]
  },
  {
    id: '04',
    ...
    paragraphs: [
      ...
      'Quando uma informação externa for relevante para uma cobertura, o RBN buscará verificar seu conteúdo e identificar sua origem.',
  ...
  },
  {
    ...
    paragraphs: [
      ...
      'O RBN buscará identificar as fontes sempre que isso for possível e adequado.',
  ...
  },
  {
    ...
    paragraphs: [
      ...
      'Quando uma informação publicada estiver incorreta, o RBN buscará corrigi-la de maneira clara, transparente e proporcional à relevância do erro.',
  ...
  },
  {
    ...
    paragraphs: [
      'As decisões jornalísticas do RBN devem ser orientadas pelo interesse jornalístico e pelo interesse público.',
  ...
  },
  {
    ...
    paragraphs: [
      'O RBN reconhece que jornalismo possui diferentes formatos.',
  ...
  },
  {
    ...
    paragraphs: [
      'O RBN não utilizará deliberadamente informações distorcidas, títulos enganosos ou recursos sensacionalistas para provocar medo, indignação ou choque e aumentar artificialmente a audiência.',
  ...
  },
  {
    ...
    paragraphs: [
      ...
      'O RBN buscará evitar exposição gratuita, humilhação ou divulgação de informações pessoais que não contribuam para a compreensão de um fato de interesse público.',
  ...
  },
  {
    ...
    paragraphs: [
      ...
      'O RBN evitará a publicação de conteúdo gráfico ou perturbador quando sua exposição não contribuir significativamente para a compreensão da notícia.',
  ...
  },
  {
    ...
    paragraphs: [
      ...
      'O RBN também reconhece que conteúdos digitais podem ser manipulados, retirados do ar, publicados fora de contexto ou atribuídos incorretamente. Por isso, a verificação de origem e contexto é parte essencial desse processo.'
    ]
  },
  {
    id: '14',
    ...
    paragraphs: [
      'O RBN reconhece o potencial da inteligência artificial como ferramenta de apoio ao jornalismo.',
  ...
  },
  {
    ...
    paragraphs: [
      'O RBN considera de interesse público informações que possam contribuir significativamente para que a sociedade compreenda acontecimentos, decisões, políticas, problemas, riscos ou situações que afetem a coletividade.',
  ...
  },
  {
    ...
    paragraphs: [
      ...
      'O RBN buscará manter canais adequados para receber manifestações dos leitores e avaliar informações que possam contribuir para corrigir ou complementar conteúdos publicados.'
    ]
  }
];

const sidebarList = [
  { label: 'O compromisso do RBN', href: '#01' },
        ...
        <article className="space-y-10">
          <header className="rounded-[28px] border border-gray-200 bg-[#F8F8F8] p-6 sm:p-8">
            <p className="text-base leading-8 text-gray-700">
              O <span className="font-medium text-gray-900">RBN</span> nasceu com o propósito de informar. Em um ambiente digital em que qualquer pessoa pode produzir e compartilhar conteúdo em poucos segundos, acreditamos que o jornalismo profissional tem uma responsabilidade ainda maior: <span className="font-medium text-gray-900">apurar, verificar, contextualizar e apresentar os fatos com clareza.</span>
            </p>
          ...
          <section className="rounded-[28px] border border-[#111111] bg-[#111111] p-6 text-white sm:p-8">
            ...
            <p className="text-base leading-8 text-gray-200">
              Os princípios editoriais do RBN representam um compromisso permanente com o leitor.
            </p>
            ...
            <p className="mt-6 text-base leading-8 text-gray-200">
              O RBN acredita que a confiança não deve ser simplesmente exigida do leitor. Ela deve ser construída todos os dias.
            </p>
          </section>
